...
class SandCore implements IPostDBLoadMod {
    ...
    public postDBLoad(container: DependencyContainer): void {
        ...
        for (const weapon in dbMastering) {
            if (dbMastering[weapon].Name == "MCX") dbMastering[weapon].Templates.push("67ac990ee8cc11a2c2ac28d0");
            if (dbMastering[weapon].Name == "M4") dbMastering[weapon].Templates.push("67acae5c6a6c938f3c4a7d4c", "67ac99d71a8e8eef28647ce3", "67acadcbc246ef38a908be82");
            if (dbMastering[weapon].Name == "AK74") dbMastering[weapon].Templates.push("67ac9a472ee3e4b51f5dd35e", "67ac9aaed7cf7c4c8f746dec", "67acad34075a8956a1527144", "67acad68d0e021eed9675bfe", "67acad9e746e609a4cd6dd61");
            if (dbMastering[weapon].Name == "G36") dbMastering[weapon].Templates.push("67acae1faf6ff63f7d5630d1");
        }
